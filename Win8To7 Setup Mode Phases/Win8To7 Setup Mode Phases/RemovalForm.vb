...
#End Region
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If HKLMKey32.OpenSubKey("Software\Longhornizer").GetValue("currentphase") = 69 Then
    ...
    Private Sub Form1_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        MsgBox("This operation cannot be cancelled.", MsgBoxStyle.Exclamation, "Longhornizer Transformation Pack ") 'lool Startup Repair reference
    ...
    Sub Phase2()
        Try
            ...
            For Each loopdirinfo In dirArr
                ...
                SetProgress("Deleting Longhornizer backups and files for user USERNAME...".Replace("USERNAME", loopdirinfo.Name))
                tries = 0
                While Not tries = 10
            ...
            'DELETE Longhornizer SYSTEM-WIDE FOLDER
            SetProgress("Deleting Longhornizer backups and files...")
            tries = 0
            While Not tries = 10
